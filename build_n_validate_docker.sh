...
docker build https://$GITHUBAT@github.com/metagenlab/microbiome16S_pipeline.git#$VERSION -t metagenlab/amplicon_pipeline:$VERSION -f ./Dockerfile . --build-arg GITHUB_AT=$_GITHUB_AT --build-arg VERSION=$_VERSIONN
