...
def get_final_output(config):
    ...
    expand("{denoiser}/5_visualization/rdp/{tax_DB}/norarefaction/ordination/{ordination_method}/{grouping_column}_{ordination_distance}.png", denoiser = config["denoiser"], tax_DB = config["tax_DB"], grouping_column=list(set(all_samples[config["grouping_column"]])), ordination_method = config["ordination_method"], ordination_distance = config["ordination_distance"]),
    ...
    expand("{denoiser}/5_visualization/rdp/{tax_DB}/rarefaction_{rarefaction_value}/ordination/{ordination_method}/{grouping_column}_{ordination_distance}.png", denoiser = config["denoiser"], tax_DB = config["tax_DB"],grouping_column=list(set(all_samples[config["grouping_column"]])), rarefaction_value=config["rarefaction_value"], ordination_method = config["ordination_method"], ordination_distance = config["ordination_distance"]),
    ...
    ###ANCOM
    expand("{denoiser}/5_visualization/rdp/{tax_DB}/norarefaction/diff_abundance/no_collapse/ANCOM/{filter_tax_rank}_{filter_lineage}_taxfilt_{column_value}_in_{meta_column}_f_{tested_factor}.qzv",  denoiser = config["denoiser"], tax_DB = config["tax_DB"], tested_factor= config["ANCOM_factors"], filter_tax_rank = config["filter_tax_rank"], filter_lineage = config["filter_lineage"], column_value = config["column_value"], meta_column = config["meta_column"]),
    expand("{denoiser}/5_visualization/rdp/{tax_DB}/norarefaction/diff_abundance/collap_{collapse_level}/ANCOM/{filter_tax_rank}_{filter_lineage}_taxfilt_{column_value}_in_{meta_column}_f_{tested_factor}.qzv",  denoiser = config["denoiser"], tax_DB = config["tax_DB"], collapse_level = config["collapse_level"], tested_factor= config["ANCOM_factors"], filter_tax_rank = config["filter_tax_rank"], filter_lineage = config["filter_lineage"], column_value = config["column_value"], meta_column = config["meta_column"]),
