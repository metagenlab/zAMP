...
ARG TEST_CPU
RUN snakemake --snakefile ${pipeline_folder}/Snakefile.insilico_validation  --cores $TEST_CPU --resources ncbi_requests=2 --use-conda --conda-prefix /opt/conda/ --configfile 16S_config_in_silico.yml insilico_validation
