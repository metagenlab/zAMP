...
:github:`**Conda environments**<rules/0_preprocessing/scripts/make_input_lists.py>` 
...
:github:`A Python script <envs>` is run at each execution of the RSP4ABM to match sequencing read files to each sample. 
